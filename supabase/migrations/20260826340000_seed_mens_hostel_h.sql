-- Phase 3A-2: seed the real, physically distinct Men's Hostel H location.
--
-- Source: Google Maps, supplied directly by the project owner.
-- Point: Men's Hostel H
-- Latitude: 12.9721565
-- Longitude: 79.1575627
--
-- New row, not a reuse of the existing 'hostel-block-h' row (that row is
-- a separate, unconfirmed-wing "Block H" with its own different
...
values ('hostel-mens-h', 'Men''s Hostel H', 'accommodation', 'mens', 12.9721565, 79.1575627, true)
