-- Phase 3A-2: seed the real, physically distinct "Ladies Hostel S" location.
--
-- Source: supplied directly by the project owner.
-- Point: Ladies Hostel S
-- Latitude: 12.9739448
-- Longitude: 79.1652998
--
-- The project owner also confirmed this is the LAST ladies-wing block:
-- no other letter beyond A-J/S has a separate ladies building. New row,
-- not a reuse of the existing 'hostel-block-s' row (that row is a
-- separate, unconfirmed-wing "Block S" seeded earlier with its own
-- (different) coordinate - see PHASE3_3A_LOCATION_SPEC.md §9a - and is
...
values ('hostel-ladies-s', 'Ladies Hostel S', 'accommodation', 'ladies', 12.9739448, 79.1652998, true)
