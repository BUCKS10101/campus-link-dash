-- Phase 3A-2: refine Men's Hostel K's coordinate.
--
-- Source: supplied directly by the project owner.
-- Point: Men's Hostel K / Latitude 12.9726417074389 / Longitude 79.16139490160037
--   Corrects the previously seeded value (12.9727675, 79.1614224, ~14m
...
update campus_points set lat = 12.9726417074389, lng = 79.16139490160037 where key = 'hostel-mens-k';
